                ...
                {this.state.step == 1 && (
                    <div className={classes.signupContainer}>
                        <div className={classes.aboveDivider}>
                            ...
                            <Button className={classes.startButton} onClick={this.switchStep}>Get started</Button>
                        </div>
                        <Divider />
                ...
                {this.state.step == 2 && (
                    <div className={classes.signupContainer}>
                        ...
                        <div className={classes.belowDividerStepTwo}>Prefer to create an account with a password?
                            <Button className={classes.buttonbelowDividerStepTwo} onClick={this.switchStep} >Click here</Button>
                        </div>
                    </div>
                )}
            </div>
